...
# Setting level
easy_color_list = ['đỏ', 'xanh dương', 'xanh lá']
easy_color_code_list = [(230, 57, 70), (17, 138, 178), (6, 214, 160)]
easy_shape_list = ['tròn', 'vuông', 'tam giác']

medium_color_list = ['đỏ', 'xanh dương', 'xanh lá', 'trắng', 'đen']
medium_color_code_list = [(230, 57, 70), (17, 138, 178), (6, 214, 160), (255, 255, 255), (64, 61, 57)]
medium_shape_lst = ['tròn', 'vuông', 'tam giác', 'oval']

hard_color_list = ['đỏ', 'xanh dương', 'xanh lá', 'trắng', 'đen', 'tím', 'cam']
hard_color_code_list = [(230, 57, 70), (17, 138, 178), (6, 214, 160), (255, 255, 255), (64, 61, 57), (218, 112, 214),
                        (255, 127, 80)]
hard_shape_list = ['tròn', 'vuông', 'tam giác', 'oval', 'sao', 'thoi']
...
def play(my_game):
    ...
    screen_text(f'Điểm số: {my_game.score}', (50, 50, 50), (150, 50))
    screen_text(f'Chọn hình {my_game.correct_answer[1]} màu {color_map[my_game.correct_answer[0]]}', (50, 50, 50),
...
def over(my_game):
    ...
    screen_text(f'Điểm số của bạn: {my_game.score}', (56, 83, 153), (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 3))
    # Reset to level 3
    my_game.update(3) 
